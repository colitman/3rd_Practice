...
<div id="content">
    <div id="navPath">
        ...
        <a href="/WebPrototype/action?code=showAllUniversityInCity&parent_id=${city.ID}">${city.name}</a> > 
        <a href="/WebPrototype/action?code=showOneUniversity&parent_id=${parent.ID}">${parent.name}</a>
    </div>
